    ...
    public static void check(final Context context, String[] permissions, String rationale,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (allPermissionProvided) {
                ...
                /*if (permissionsList.get(0).equalsIgnoreCase("android.permission.ACCESS_FINE_LOCATION")) {
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(context);
                    builder1.setTitle("Disclaimer");
                    builder1.setMessage("Sim app collects location data to accurately map your outlet to nearest distributor when the app is in use.");
